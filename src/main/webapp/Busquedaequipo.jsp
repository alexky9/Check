...
.container .content table tr td fieldset table tr td #sprycheckbox2 {
	font-family: "Lucida Console", Monaco, monospace;
	font-size: 12px;
	font-weight: bold;
}
...
.container .content table tr td fieldset table tr td #sprycheckbox4 {
	font-family: "Lucida Console", Monaco, monospace;
}
.container .content table tr td fieldset table tr td #sprycheckbox4 {
	font-size: 12px;
...
.container .content table tr td fieldset table tr td #sprycheckbox5 {
	font-family: "Lucida Console", Monaco, monospace;
}
.container .content table tr td fieldset table tr td #sprycheckbox5 {
	font-size: 12px;
...
.container .content table tr td fieldset table tr th #sprycheckbox6 {
	font-family: Georgia, "Times New Roman", Times, serif;
}
.container .content table tr td fieldset table tr th #sprycheckbox6 #Open Office {
	font-size: 12px;
}
.container .content table tr td fieldset table tr th #sprycheckbox6 #Open Office {
	font-weight: bold;
...
.container .content table tr td fieldset table tr td #sprycheckbox7 {
	font-family: "Lucida Console", Monaco, monospace;
}
.container .content table tr td fieldset table tr td #sprycheckbox7 {
	font-size: 12px;
...
.container .content table tr td fieldset table tr td #sprycheckbox8 {
	font-family: "Lucida Console", Monaco, monospace;
}
.container .content table tr td fieldset table tr td #sprycheckbox8 {
	font-size: 12px;
...
.container .content table tr td fieldset table tr td #sprycheckbox9 {
	font-size: 12px;
}
.container .content table tr td fieldset table tr td #sprycheckbox9 {
	font-family: "Lucida Console", Monaco, monospace;
...
.container .content table tr td fieldset table tr td #sprycheckbox10 {
	font-family: "Lucida Console", Monaco, monospace;
}
.container .content table tr td fieldset table tr td #sprycheckbox10 {
	font-size: 12px;
...
.container .content table tr td fieldset table tr th #sprycheckbox11 {
	font-weight: bold;
}
.container .content table tr td fieldset table tr td #sprycheckbox12 {
	font-size: 12px;
}
.container .content table tr td fieldset table tr td #sprycheckbox12 {
	font-family: "Lucida Console", Monaco, monospace;
...
.container .content table tr td fieldset table tr td #sprycheckbox13 {
	font-size: 12px;
}
.container .content table tr td fieldset table tr td #sprycheckbox13 {
	font-family: "Lucida Console", Monaco, monospace;
...
.container .content table tr td fieldset table tr td #sprycheckbox14 {
	font-size: 12px;
}
.container .content table tr td fieldset table tr td #sprycheckbox14 {
	font-family: "Lucida Console", Monaco, monospace;
...
.container .content table tr td fieldset table tr td #sprycheckbox15 {
	font-size: 12px;
}
.container .content table tr td fieldset table tr td #sprycheckbox15 {
	font-family: "Lucida Console", Monaco, monospace;
...
.container .content table tr td fieldset table tr th #sprycheckbox16 {
	font-weight: bold;
}
.container .content table tr td fieldset table tr td {
	font-size: 12px;
...
<div class="container">
  <div class="sidebar1">
    ...
    <p>&nbsp;</p>
    <p>&nbsp;</p>
      <li><a href="#">Agregar CheckList</a></li>
      
      <li><a href="#">Buscar CheckList</a></li>
    </ul>
    <p>&nbsp;</p>
    <!-- end .sidebar1 --></div>
  <div class="content">
...
Actualizacion y parches</td>
      ...
      <tr>
        ...
        <td width="11">&nbsp;</td>
        <td>&nbsp;</td>
        <td><input type="submit" name="Guardar" id="Guardar" value="Imprimir" /></td>
        <td><input type="reset" name="Limpiar" id="Limpiar" value="Regresar" /></td>
        <td>&nbsp;</td>
        <td colspan="2">&nbsp;</td>
      </tr>
    </table>
